...
if(isset($_POST['name']) || isset($_POST['email']) || isset($_POST['message'])){
	 ...
	 $admin_email = "shalu.sienti@gmail.com";
	 $name=$_POST['name'];
	 $email=$_POST['email'];
	 $subject='New Enquiry From Fineday';
	 $code=$_POST['code']; 
	 $phone=$_POST['phone'];
...
<table width="600" border="0" bgcolor="#fff" style="border:none;">
  ...
  <tr style="border:none;">
    ...
    <td width="100" style="border:none;"><img src="http://sientisolutions.com/clients/thecandidwedding.com/html/html10/img/logo.png"  /></td>
