...
<html>
	<head>
        ...
        <style>
			input[type="text"],input[type="date"],input[type="password"],  input[type="email"],  input[type="number"],  input[type="search"],  input[type="url"],  select,  textarea {
				border: none;
			}
			input[type="number"]{
				width:50%;	
                ...
                <section>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr> 
                                        ...
                                        <td colspan="2"><input type="date" class="form-control"  name="date" id="datecal" required  onChange="getdatebalance();"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5"><label>Cheque Details</label></td>
								...
								$con=mysqli_connect("localhost","smpbook","smpbook","smpbook");
								$today=date("Y-m-d");
                               	$todayquery=mysqli_query($con,"SELECT MAX(date) AS maxdate FROM sale where date<'".$today."'");
                                ...
                                <tr>
                                    ...
                                    <td style="color:black;">Opening Cash
                                        <select name="customer[]" id="customer1"  style="display:none;">
                                            <option value="other">other</option>
                                            
                                        </select>
                                        <div id="text1">
                                        <input type="text"  id="particular1" name="particular[]" value="Opening Cash" readonly style="display:none;">	
                                        </div>                        
                                    </td> 
                                    <td><input type="text" class="form-control" id="debit1" name="debit[]"   value="<?php echo $openingbalance; ?>" readonly onKeyUp="getbalance(1);"></td> 
                                    <td><input type="text" class="form-control" id="credit1" name="credit[]" onKeyUp="getbalance(1);"></td> 
                                    <td><input type="text" class="form-control" id="balance1" name="balance[]" value="<?php echo $openingbalance; ?>" readonly></td> 
                                ...
                                <tr>  
                                    ...
                                    <td>
                                        <select name="customer[]" id="customer1" onChange="getval(1)" >
                                            <option value="select">select</option><option value="To Bank">To Bank</option>
                                            <?php 
                                            $con=mysqli_connect("localhost","smpbook","smpbook","smpbook");
                                    ...
                                    <td><input type="text" class="form-control" id="debit1" name="debit[]"   onKeyUp="getbalance(1);"></td> 
                                    <td><input type="text" class="form-control" id="credit1" name="credit[]" onKeyUp="getbalance(1);"></td> 
                    ...
                    <tr>
                        ...
                        <select name="customer[]" id="customer10" onChange="getval(10)" >
                        	<option value="select">select</option><option value="select">select</option><option value="To Bank">To Bank</option>
                            <?php 
