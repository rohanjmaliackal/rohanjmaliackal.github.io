                            	...
                            	<table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                   ...
                                   $con=mysqli_connect("localhost","smpcashbook","smpcashbook","smpcashbook");
                                    ...
                                    if($res=mysqli_fetch_row($query)>0){
                                        $j=0;
                                        $qry=mysqli_query($con,"select * from bank");
                                        while($row=mysqli_fetch_array($qry)){
                                            ...
                                            <tr>
                                                ...
                                                <td class="center">
                                                    <a class="btn btn-info" href="edit.php?page=bank&&id=<?php echo $row['bank_id']; ?>">
                                                        <i class="glyphicon glyphicon-edit icon-white"></i>Edit
                                                    </a>
                                                    <a class="btn btn-danger" href="delete.php?page=bank&&id=<?php echo $row['bank_id']; ?>" onclick="return myFunction();">
...
<script>
function myFunction() {
    var person = prompt("Are you sure you want to delete this Bank");
