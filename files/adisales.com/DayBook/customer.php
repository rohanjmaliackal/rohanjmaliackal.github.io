                            	...
                            	<table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                    ...
                                    if($res=mysqli_fetch_row($query)>0){
                                        ...
                                        while($row=mysqli_fetch_array($qry)){
                                            ...
                                            <tr>
                                                <td><?php echo $j; ?></td>
                                                <td class="center"><?php if($row['orgname']==''){ echo "-"; }else{ echo $row['orgname']; } ?></td>
                                                <td class="center"><?php echo $row['name']; ?></td>
                                                <td class="center"><?php echo $row['address']; ?></td>
                                                <td class="center"><?php echo $row['mobile']; ?></td>
                                                <td class="center">
                                                    <a class="btn btn-info" href="edit.php?page=customer&&id=<?php echo $row['customer_id']; ?>">
                                                        <i class="glyphicon glyphicon-edit icon-white"></i>Edit
                                                    </a>
                                                    <a class="btn btn-danger" href="delete.php?page=customer&&id=<?php echo $row['customer_id']; ?>" onclick="return myFunction();">
...
<script>
function myFunction() {
    var person = prompt("Are you sure you want to delete this Customer");
