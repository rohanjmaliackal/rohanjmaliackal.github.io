		...
		$admin_email = "weddingbellsalbums@gmail.com";
		...
		$choose=$_POST['choose'];
		$code=$_POST['code'];
	    $subject="New Enquiry from Wedding Bells";
		$date=date("d-m-Y");
...
<a href="http://weddingbellsphotography.co.in">

<img src="http://weddingbellsphotography.co.in/images/blakwatrmark.png" width="204" style="display:block;font-family:arial,helvetica,serif;font-size:15px;color:#f00c6b" class="CToWUd">
</a>
...
<table width="100%" border="0" style="margin-top:20px;">
  ...
  <tr>
   ...
   <tr>
    <td valign="top" style="padding:0px 0px 0px 0px; height:40px;">
    <p style="font-family:Helvetica,Arial,sans-serif;color: #3b3c3a; padding: 9px 0px;"><strong>Subject: '.$choose.'&nbsp;</strong></p></td>
  </tr>
