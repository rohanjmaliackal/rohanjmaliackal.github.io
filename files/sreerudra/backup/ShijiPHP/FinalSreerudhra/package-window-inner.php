...
<div class="container">
    <div class="row">
          ...
          <div class="col-md-12">
                    ...
                    <center>
                       <img src="admin/upload/package/<?php echo $row['image']; ?>" alt="First slide" class="img-responsive">
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
        <h3 class=" fadeInUp inner_head">
            <span class="running"><?php echo $row['heading']; ?></span>
            <span href="Lake_View_Cottage.php" class="pull-right golden_color running">Price:&nbsp;<?php echo $row['price']; ?></span>
        </h3>
        <br>
