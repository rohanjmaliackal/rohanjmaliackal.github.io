...
if(!isset($_GET['specialist']) || !isset($_GET['doctor']) || !isset($_GET['disease']) || ($_GET['doctor']=='') || ($_GET['specialist']=='')){
	...
	if(!isset($_SESSION["login_id"])){
		...
		$date=$_GET['date'];
		header("location:login.php?specialist=$specialist && doctor=$doctor && date=$date && disease=$disease && page=online-appointment");
	}
}
?>
<!DOCTYPE html>
        ...
        $(document).ready(function() {
            $('#floating_timepicker').timepicker({
                onSelect: function(time, inst) {
                    $('#floating_selected_time').php('You selected ' + time);
                }
            });
...
.image-wrapper-oa {
    background: url(img/meditation.jpg) no-repeat center;
    min-height: 415px;
...
<div class="col-md-12">
                    <div class="well-block">
                        ...
                        <input id="specialist" name="specialist" type="text" value="<?php echo $_GET['specialist']; ?>" hidden="true">
                         <input id="doctor" name="doctor" type="text" value="<?php echo $_GET['doctor']; ?>" hidden="true">
                          <input id="price" name="price" type="text" value="100" hidden="true">
                            ...
                            <div class="row">
                                ...
                                <!-- Text input-->
                                 <div class="col-md-6">
                                    <div class="form-group">
										...
										?>
                                        <input id="disease" name="disease" type="text" placeholder="Disease" value="<?php echo $_GET['disease']; ?>" class="form-control input-md">

                                        <?php
										}else{
										?>
                                         <input id="disease" name="disease" type="text" placeholder="Disease"  class="form-control input-md">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        if(isset($_GET['date'])){
										?>
                                         	<input id="mdp-demo" class="form-control input-md" name="date" value="<?php echo $_GET['date']; ?>" placeholder="Preferred Date" onChange="getTimeBook();">
											<script>
                                            $('#mdp-demo').datepicker();
                                            </script> 
                                        <?php
										...
										?>
                                         <input id="mdp-demo" class=" form-control" name="date" onChange="getTimeBook();">
											<script>
                                            $('#mdp-demo').datepicker();
                                            </script> 
                                        <?php	
                               ...
                               <!-- <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="time">Preferred Time</label>
                                         <input type="text" id="timepicker_2" value="04:30 PM" class="timepicker form-control input-md"  name="to" />
											<script type="text/javascript">
                                                $(document).ready(function() {
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="time">Preferred Time</label>
                                         <input type="text"  id="totime" class="form-control input-md"  name="to" onClick="getTimeBook();"/>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="submit" id="singlebutton" value="Make An Appointment" name="singlebutton" class="btn btn-default" style="margin-top: 2%;background-color: #76b51b;">
                                    </div>
                                </div>
                            </div>
                        </form>
...
<script>
   function getTimeBook() { 
	  ...
	  xhttp.open("GET", "ajaxtime.php?doctor="+doctor+"&& specialist_id="+specialist_id+"&& date="+date, true);
	  xhttp.send();
	}
   </script>
