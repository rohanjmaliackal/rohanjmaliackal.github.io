         ...
         <div class="inner-wrapper">
            <div class="our-ser">
              ...
              <div class="container">
				 ...
				 $query=mysqli_query($con,"select * from package limit 6");
				 ...
				 .services-rectangle-three<?php echo $i; ?>{
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                       <div class="services-rectangle-three<?php echo $i; ?>">
                          <div class="hear">
                       <a href="package-window-inner.php?package_id=<?php echo $row['package_id']; ?>"><i class="fa fa-heart fa-2x" style="color:#FFFFFF;" aria-hidden="true"></i>
				 ...
				 ?>
                   ...
                   <!--<div class="but">
     <button class="button button2"><a href="our-specialities.html">Read More</a></button>
                   </div>-->
                     <br>
                     <br>
