                                ...
                                <div class="div_class">
                                   ...
                                   <!-- <div class="search_div">
                                     ...
                                     <?php
											...
											$query_select_booking=mysqli_query($con,"select * from booking,doctor where booking.status='0' and doctor.status='0' and booking.doctor_id=doctor.doctor_id and booking.user_id='".$user_id."' order by booking.booking_id DESC");
                                     ...
                                     <table id="myTable" class=" pagination  searchable  table_style_3 css_class">
                                        ...
                                        <tr>
                                            ...
                                            <th data-sort="String">Specialist</th>
                                            <th data-sort="Fixnum">Doctor's name</th>
                                            <th data-sort="Fixnum">Disease</th>
                                       ...
                                       <?php
                                                ...
                                                while($row_booking=mysqli_fetch_array($query_select_booking)){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row_booking['disease']; ?></td>
                                                        ...
                                                        <td><?php echo $row_booking['time']; ?></td>
                                                         <td><?php echo $row_booking['tocken']; ?></td>
                                                           ...
                                                           <td><?php if($row_booking['pay']=='0'){ echo "Not Paid";
															   ...
															   ?>
<?php /*?>
<a href="pay.php?name=<?php echo $row_booking[4]; ?>&&phone=<?php echo $row_booking['phone']; ?>&&email=<?php echo $row_booking['email']; ?>&&amount=<?php echo $row_booking['fee']; ?>&&paynow=Pay Online" style="color:#297ce6;">Pay Now</a><?php */?>

<?php
														   }else{ echo $row_booking['pay']; }?></td>
                                                          <td><?php if($row_booking['stat']=='admin'){ echo "rejected"; }else{ echo ""; } ?></td>
                                                        <th>
                                                        ...
                                                        <?php if($row_booking['st']=='completed'){ 
															...
															?>
                                                        <a href="delete-booking.php?booking_id=<?php echo $row_booking['booking_id']; ?>&&email=<?php echo $row_booking['email']; ?>&&phone=<?php echo $row_booking['phone']; ?>" class="btn  btn_create upload-result"   style="background: rgb(218, 28, 28);width:95%;float:left;color: #fff;" onclick="return myDelete();">Cancel</a>     
															<?php
														}
														?>
                                                        </th>
...
<script>
function myDelete() {
    var person = prompt("Are you sure you want to delete, Enter yes or no here");
