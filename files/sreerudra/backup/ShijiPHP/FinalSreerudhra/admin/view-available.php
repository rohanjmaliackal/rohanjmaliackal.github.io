        ...
        <div class="leftside-navigation">
           <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                  ...
                  <li>
                    <a href="availabile.php" class="active">
                                   ...
                                   <!-- <div class="search_div">
                                    ...
                                    <table id="myTable" class=" pagination  searchable  table_style_3 css_class">
                                        ...
                                        <tr>
                                            ...
                                            <th data-sort="Fixnum">Unavailable Time</th>
                                        ...
                                        <?php
                                            ...
                                            $query_select_available=mysqli_query($con,"select * from available,doctor where available.status='0' and doctor.status='0' and available.doctor_id=doctor.doctor_id order by available.available_id DESC");
                                            if(mysqli_fetch_row($query_select_available)>0){
                                                $i=0;
                                                $query_select_available=mysqli_query($con,"select * from available,doctor where available.status='0' and doctor.status='0' and available.doctor_id=doctor.doctor_id order by available.available_id DESC");	
                                                while($row_available=mysqli_fetch_array($query_select_available)){
                                                    $i++;
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $row_available['specialist']; ?></td>
                                                        <td><?php echo $row_available['name']; ?></td>
                                                        <td><?php echo $row_available['date']; ?></td>
                                                         <td><?php echo $row_available['time_from']; echo "-"; echo $row_available['time_to']; ?></td>
                                                        <th>
                                                            <a href="delete-available.php?available_id=<?php echo $row_available['available_id']; ?>" class="btn  btn_create upload-result"   style="background: rgb(118, 60, 60);width:35%;float:left;color: #fff;" onclick="return myDelete();">Delete</a>
