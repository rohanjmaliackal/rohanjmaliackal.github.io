	...
	<section class="wrapper">
		<div class="form-w3layouts">
	 		<div class="row">
                        ...
                        <div class="panel-body">
							...
							if(isset($_GET['msg'])){ ?>
								...
								<div class="alert alert-danger" style="width:50%;">
									...
									<strong>Success!</strong> Package Details Updated Successfully.
								</div>
								</center>
							<?php
							}
                ...
                <form class="cmxform form-horizontal" action="edit-package-action.php" method="post" enctype="multipart/form-data" name="multiple_upload_form" id="multiple_upload_form">
                                     <?php
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input id="package_id" name="package_id" type="text" value="<?php echo $row_package['package_id']; ?>" hidden="true">
                                            <input class=" form-control" id="heading" name="heading" type="text" value="<?php echo $row_package['heading']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="lastname" class="control-label col-lg-3">Price</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="price" name="price" type="text" value="<?php echo $row_package['price']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            //<![CDATA[
                                              ...
                                              <textarea name="specification" cols="40" ><?php echo $row_package['specification']; ?>
                                            </textarea><br />
                                    ...
                                    <div class="form-group">
                                         ...
                                         <div class="col-lg-6">
                                          <img id="myImg" src="upload/package/<?php echo $row_package['image']; ?>" style="width:20%;">
                                            </br></br>
