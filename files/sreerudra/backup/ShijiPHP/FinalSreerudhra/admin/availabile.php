...
<section id="main-content">
	<section class="wrapper">
		<div class="form-w3layouts">
         <a href="view-available.php" class="btn btn-primary upload-result" style="float:right;">
                ...
                <div class="col-lg-12" >
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                			...
                			<form class="cmxform form-horizontal" action="available-action.php" method="post" >
                                    ...
                                    <div class="form-group ">
                                     ...
                                     <div class="form-group ">
                                        <label for="lastname" class="control-label col-lg-3">Unavailable Time </label>
                                        <div class="col-lg-6">
