...
<div class="image-wrapper-cu">
   ...
   <i class="fa fa-map-marker" aria-hidden="true" style=" margin-right:10px;"></i><p><li type="disc">Sreerudra Ayurveda Multi Speciality Hospital Kaithavana
Alappuzha – 688003</li></p><br>

                   
                    
      <i class="fa fa-envelope-o" aria-hidden="true" style=" margin-right:10px;"></i><p><li type="disc">sreerudraayurvedahospitalalpy@gmail.com</li></p><br>

                
     
     
      <i class="fa fa-phone" aria-hidden="true" style=" margin-right:10px;"></i><p><li type="disc">+91 477 2266778, +91 9847948218</li></p>
