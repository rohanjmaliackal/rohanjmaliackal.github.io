                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="name" type="text" placeholder="Name" class="form-control input-md" value="<?php echo $_GET['name']; ?>">
                                    </div>
                                </div>
                                <!-- Text input-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="email" name="email" type="text" placeholder="E-Mail" class="form-control input-md" value="<?php echo $_GET['email']; ?>">
                                    </div>
                                </div>
                                <!-- Text input-->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="phone" name="phone" type="text" placeholder="Phone" class="form-control input-md" value="<?php echo $_GET['phone']; ?>">
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="amount" name="amount" type="text" placeholder="Amount" class="form-control input-md" value="<?php echo $_GET['amount']; ?>">
                                    </div>
                                </div>
                               ...
                               <!-- <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                   <!--       <input type="submit" id="singlebutton" value="Pay Online" name="paynow" class="btn btn-default" style="margin-top: 2%;background-color: #76b51b;">  -->
                                           <input type="submit" id="singlebutton" value="Pay Later" name="paylater" class="btn btn-default" style="margin-top: 2%;background-color: #76b51b;">
                                    </div>
