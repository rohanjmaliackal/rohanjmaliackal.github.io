                                   ...
                                   <!-- <div class="search_div">
                                    ...
                                    <table id="myTable" class=" pagination  searchable  table_style_3 css_class">
                                        ...
                                        <tr>
                                            ...
                                            <th data-sort="Fixnum">Price</th>
                                            <th data-sort="Fixnum">Image</th>
                                        ...
                                        <?php
                                            ...
                                            $query_select_package=mysqli_query($con,"select * from package where status='0' order by package_id DESC");
                                            if(mysqli_fetch_row($query_select_package)>0){
                                                $i=0;
                                                $query_select_package=mysqli_query($con,"select * from package where status='0' order by package_id DESC");	
                                                while($row_package=mysqli_fetch_array($query_select_package)){
                                                    $i++;
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $row_package['heading']; ?></td>
                                                        <td><?php echo $row_package['price']; ?></td>
                                                        <td><img src="upload/package/<?php echo $row_package['image']; ?>" style="width:90%;height:100px;"/></td>
                                                        <th>
                                                            <a href="delete-package.php?package_id=<?php echo $row_package['package_id']; ?>" class="btn  btn_create upload-result"   style="background: rgb(224, 9, 9);width:32%;float:left;color: #fff;" onclick="return myDelete();">Delete</a>
                                                            <a href="edit-package.php?package_id=<?php echo $row_package['package_id']; ?>" class="btn  btn_create upload-result"   style="background: rgb(21, 114, 195);width:32%;float:left;color: #fff;margin-left: 1%;" >Edit</a>
                
                                                            <a href="package-details.php?package_id=<?php echo $row_package['package_id']; ?>" class="btn  btn_create upload-result"   style="background: #0a7440;width:32%;float:left;color: #fff;margin-left: 1%;" >View</a>
                                                        </th>
                                                    </tr>
