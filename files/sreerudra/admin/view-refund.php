        ...
        <div class="leftside-navigation">
           <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                 ...
                 <li>
                    <a href="view-refund.php" class="active">
                         <i class="fa fa-stack-exchange"></i>
                        <span>Refund</span>
                    </a>
                </li>
                                   ...
                                   <!-- <div class="search_div">
                                    ...
                                    <table id="myTable" class=" pagination  searchable  table_style_3 css_class">
                                        ...
                                        <tr>
                                            ...
                                            <th data-sort="Fixnum">Mobile</th>
                                            <th data-sort="Fixnum">Refund</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                            require_once("connect.php");
                                            $query_select_booking=mysqli_query($con,"select * from booking,doctor where (booking.status='1' and doctor.status='0' and booking.doctor_id=doctor.doctor_id) and (pay='paid' or pay='refund') order by booking.booking_id DESC");
                                            if(mysqli_fetch_row($query_select_booking)>0){
                                                ...
                                                while($row_booking=mysqli_fetch_array($query_select_booking)){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                           <?php if($row_booking['pay']=='paid'){
															   ?><a href="refund.php?booking_id=<?php echo $row_booking['booking_id']; ?>&&user_id=<?php echo $row_booking['user_id']; ?>&&name=<?php echo $row_booking[4]; ?>&&phone=<?php echo $row_booking['phone']; ?>&&email=<?php echo $row_booking['email']; ?>">Refund Now</a><?php
														   }else if($row_booking['pay']=='refund'){ echo "refund";
															   ?><?php
														   }else{ echo "Not Paid"; }?>
                                                        </th>
                                                    </tr>
