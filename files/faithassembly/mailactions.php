	    ...
	    $subject="New Newsletter Request From Faithassembly";
		$date=date("d-m-Y");
...
<table width="100%" border="0" style="margin-top:20px;">
   ...
   <tr>
    ...
    <p style="font-family:Helvetica,Arial,sans-serif;color: #3b3c3a; padding: 9px 0px;"><strong>Name: '.$names.'&nbsp;</strong></p></td>
  </tr>
  ...
  <tr>
   ...
   <tr>
    <td valign="top" style="padding:0px 0px 0px 0px; height:40px;">
    <p style="font-family:Helvetica,Arial,sans-serif;color: #3b3c3a; padding: 9px 0px;"><strong>Mobile NUmber: '.$mobiles.'&nbsp;</strong></p></td>
  </tr>
